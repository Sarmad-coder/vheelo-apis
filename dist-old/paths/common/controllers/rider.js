...
const findAll = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        return res.json({ status: "success", data: yield rider_1.default.findAll() });
    }
    catch (error) {
...
const findByQuery = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        return res.json({ status: "success", data: yield rider_1.default.findByQuery(req.query) });
    }
    catch (error) {
...
const findById = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        return res.json({ status: "success", data: yield rider_1.default.findById(req.params.id) });
    }
    catch (error) {
